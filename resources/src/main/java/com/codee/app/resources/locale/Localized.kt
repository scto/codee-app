...
internal constructor(
    ...
    public infix fun T.to(locale: Locale): Unit = appendVariant(locale, this)
}

public operator fun <T> Localized<T>.get(locale: Locale): T = variants[locale] ?: default
