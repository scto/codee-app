...
public abstract class AppStrings {
    public open val projects: LocalizedString by
        localized("Projects") {
            "Projects" to Locale.en
            "Проєкти" to Locale.uk
            "Проекты" to Locale.ru
        }
    public open val project: LocalizedString by
        localized("Project") {
            "Project" to Locale.en
            "Проект" to Locale.ru
            "Проєкт" to Locale.uk
        }
    public open val createProject: LocalizedString by
        localized("Create project") {
