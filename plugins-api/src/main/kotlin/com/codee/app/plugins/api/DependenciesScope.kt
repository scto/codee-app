...
/**
 * Used in **manifest.codee.kts** for specifying external dependencies. Runs after declaring plugin
 * info if everything is okay (for example, compatibility settings are approved).
 */
...
public fun DependenciesScope.implementation(coordinates: String, mavenRepository: String): Unit =
    implementation(coordinates) { repositories { maven(mavenRepository) } }
