...
/**
 * Plugin's metadata scope. It is place where plugins declare their names, versions, compatibility
 * settings, etc. Will be in separated file **manifest.codee.kts**.
 */
...
public interface CodeeCompatibilitySettingsScope {
    /**
     * Minimum supported codee version of plugin (if plugin incompatible with user's version, user
     * will be noticed automatically). It is optional value, but better to specify explicitly.
     */
    public var minCodeeVersion: Int?

    /**
     * Maximum supported codee version of plugin (optional parameter, in most of cases you don't
     * need to specify)
     */
