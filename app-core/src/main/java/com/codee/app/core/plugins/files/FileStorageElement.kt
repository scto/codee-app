...
internal constructor(private val origin: File, private val rootDirectory: File) :
    IFileStorageElement {
    ...
    override suspend fun write(bytes: ByteArray) =
        withContext(Dispatchers.IO) { origin.writeBytes(bytes) }

    override suspend fun delete(): EmptyStorageElement =
        withContext(Dispatchers.IO) {
            origin.delete()
